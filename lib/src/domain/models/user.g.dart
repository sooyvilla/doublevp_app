...
void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.addresses
      .attach(col, col.isar.collection<Address>(), r'addresses', id);
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> addresses(
      FilterQuery<Address> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'addresses');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'addresses', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'addresses', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'addresses', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'addresses', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'addresses', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> addressesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'addresses', lower, includeLower, upper, includeUpper);
    });
  }
}
